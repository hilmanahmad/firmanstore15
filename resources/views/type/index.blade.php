...
<script type="text/javascript" src="{{ asset('assets') }}/js/myJs/type.js"></script>
@section('container')
                ...
                <div class="col-sm-5">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form action="{{ route('type.store') }}" method="POST" id="formData">
                                @csrf
                                <div class="form-row">
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                ...
                                <table id="datagrid" class="easyui-datagrid" url="{{ url('/type-datatable') }}"
    ...
    <form id="delete-form" action="/type/" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
    @stack('scripts')
